...
static OS_TMR *MyTmr1; //one shot timer
static OS_TMR *MyTmr2; //periodic timer
static OS_TMR *MyTmr3;//one shot timer
static OS_TMR *MyTmr4;//periodic timer
